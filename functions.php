...
function gem_register_styles() {
    ...
    wp_enqueue_style('gem-style', get_template_directory_uri() . '/assets/css/style.css', array('gem-reset-css','gem-tailwind-css', 'gem-bootstrap-css'), $version, 'all');
    wp_enqueue_style('gem-reset-css', get_template_directory_uri() . './assets/css/reset.css', array(), $version, 'all');
    wp_enqueue_style('gem-tailwind-css', 'https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css', array('gem-reset-css'), '1.0.0', 'all');
    wp_enqueue_style('gem-bootstrap-css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css', array('gem-reset-css'), '5.0.1', 'all');
